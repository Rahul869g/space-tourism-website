...
const technology = () => {
  ...
  return (
    <div className="fixed w-full h-screen bg-cover bg-center bg-[url('../src/assets/technology/background-technology-mobile.jpg')] sm:bg-[url('../src/assets/technology/background-technology-tablet.jpg')] lg:bg-[url('../src/assets/technology/background-technology-desktop.jpg')]">
      <div className="uppercase text-white text-center text-base tracking-widest md:text-start md:pl-9 lg:text-3xl">
        <span className="text-gray-500 mr-4 font-extrabold opacity-70">03</span>
        Space Lauch 101
      </div>

      <div className="lg:flex lg:flex-row-reverse lg:items-center lg:gap-x-[10%]">
        <div
        ...
        >
              ...
              <label
                ...
                className={`text-lg border-[1px] border-white-opacity w-9 h-9 
                  ...
                  hover:border-main-white ${
                    ...
                    // i === index ? "bg-main-white text-[#000]" : ""
                  }
          ...
          <div className="text-white tracking-wider lg:text-left">
            <h4 className="text-sm lg:text-xl">THE TERMINOLOGY…</h4>
            <h2
            ...
            <p className="m-auto text-[#D0D6F9] text-base max-w-[340px] opacity-70 sm:max-w-[400px] lg:m-0 lg:text-xl lg:max-w-[480px]">
