...
const Nav = () => {
  ...
  return (
    ...
    >
      ...
      {/* Nav container */}
      <hr
        className="hidden lg:block absolute top-9 left-[12%] border border-white-opacity
          w-[30%] z-50"
      />
      <div
      ...
      >
        ...
        >
          <img
            ...
            alt="x de cierre de menu"
          />
        </button>
        {/* Link container */}
        <nav
          className="text-white font-barlow text-sm mt-[20vh] p-7 tracking-[.2em]
